/* Requires */
try {
    const CourseObject = require("./CourseObject.js");
} catch(err) {}
...
class MonsterObject extends CourseObject {
    ...
    _extAttributes(_objectData) {
        let flags = _objectData.flags, type = _objectData.type,
            subType = ((flags & 7) & 4) >> 2,
            wing = ((flags & 7) & 2) >> 1,
            size = (type !== 3) ? ((flags & 16384) >> 14) + 1 : 1, /* 0x4000 = 16384 */
            extend = [],
            direction = (_objectData.flags >> 23) & 3, /* 0x17 = 23 */
