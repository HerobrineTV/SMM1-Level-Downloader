...
class Course {
    ...
    constructor(_objectData) {
        ...
        this.month = ("00" + _objectData.month).slice(-2); this.day = ("00" + _objectData.day).slice(-2);
        this.hour = ("00" + _objectData.hour).slice(-2); this.minute = ("00" + _objectData.minute).slice(-2);
        this.name = _objectData.name;
        this.mode = _objectData.mode;
        this.theme = _objectData.theme; this.themeName = _objectData.themeName;
        this.timeLimit = _objectData.timeLimit;
        this.scroll = _objectData.scroll; this.scrollName = _objectData.scrollName;
