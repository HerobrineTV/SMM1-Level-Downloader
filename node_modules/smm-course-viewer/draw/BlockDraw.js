...
BlockDraw._defitions = {
    ...
    5:{"xT":2, "yT":0},
    6:{"xT":6, "yT":0},
    7:{"extend":function(courseObject) {
        let xT = 8, yT = 11,
            xMax = 15;
    ...
    14:{"extend":function(courseObject) {
        let width = courseObject.width;
        let height = courseObject.height;
        let color = (courseObject.flags >> 18) & 3; /* {0} red , {1} yellow , {2} green */
        /* mushroom head */
        var tt = { 9:{"xT":3, "yT":2}, 10:{"xT":4, "yT":2}, 11:{"xT":5, "yT":2} };
        if(color === 1) {/* color {1} */
            tt[9]= {"xT":3, "yT":3};
            tt[10] = {"xT":4, "yT":3};
            tt[11] = {"xT":5, "yT":3};
        ...
        var extend = BlockDraw._extend3x4objects(0, (height-1), width, 1, tt);
        /* mushroom body */
        if(width%2 === 0) {
    ...
    16:{"extend":function(courseObject) {
        let width = courseObject.width;
        let height = courseObject.height;
    ...
    17:{"extend":function(courseObject) {
        let width = courseObject.width;
        var tt = {
    ...
    29:{"xT":3, "yT":0},
    37:{"extend":function(courseObject) {
        let width = courseObject.width - 3;
        let height = courseObject.height;
        var tt = {
    ...
    63:{"xT":8, "yT":7},
    64:{"extend":function(courseObject) {
        let height = courseObject.height;
        var extend = [];
        for(let h=0; h<height; h++) {
