...
class Draw {
     ...
     * @arg {Boolean} _bgInvis      Invisible background
     * @instance
     * @access public
     * @return {this}
     */
    constructor(_element, _course, _objects, _sizeBase=20, _bgInvis) {
        /* define element plot */
        ...
        /* call functions */
        this._init();
        this._drawBackground(this._widthBlock, this._heightBlock, _bgInvis);
     ...
     * @arg {Boolean} _bgInvis    Background invisible
     * @access private
     * @return {null}
     */
    _drawBackground(_X, _Y, _bgInvis) {
        const $this = this;
        ...
        if (_bgInvis == false) {
            ...
            bg.src = "../node_modules/smm-course-viewer/layout/draw/support/transparent-bg.png";
        }
    }
