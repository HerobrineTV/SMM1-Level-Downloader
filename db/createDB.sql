CREATE DATABASE `FloriansDB` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;

CREATE TABLE `Levels` (
  `EntryID` bigint(20) NOT NULL AUTO_INCREMENT,
  `clears` bigint(20) DEFAULT NULL,
  `creator_mii_data` varchar(100) DEFAULT NULL,
  ...
  `creator_nnid` varchar(100) DEFAULT NULL,
  ...
  `world_record_best_time_player_nnid` varchar(100) DEFAULT NULL,
  ...
  `world_record_first_complete_player_nnid` varchar(100) DEFAULT NULL,
...
ALTER TABLE FloriansDB.Levels ADD CONSTRAINT `PRIMARY` PRIMARY KEY (EntryID);
